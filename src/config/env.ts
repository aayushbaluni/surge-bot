...
const defaultValues: Partial<Environment> = {
  ...
  WEBSITE_URL: 'https://surgetrade.io',
  TWITTER_URL: 'https://x.com/TheSurgeCoin',
  TELEGRAM_CHANNEL: 'https://t.me/SurgePro_Chat',
  SURGE_ANNOUNCEMENTS_CHANNEL: 'https://t.me/SURGE_INFO',
  PRIVATE_GROUP_LINK: 'https://t.me/SURGE_ProPrivate',
